# You are building UI in the app.forhims.com design system.
...
- families   sofia · Times
- weights    500 · 400
- base size  16px

## Spacing

- scale      2px · 60px · 80px · 100px · 120px · 133px · 178px · 210px · 234px · 285px · 320px · 360px

## Radii

- scale      20px · 27px · 45px · 52px · 100px
...
```bash
npx designlang app.forhims.com
```
...
Generated by designlang. Re-extract by running `npx designlang app.forhims.com`.
